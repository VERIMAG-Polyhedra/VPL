...
let mkTriv : 'c Cert.t -> Cstr_type.cmpT -> Scalar.Rat.t -> 'c t
	= fun factory cmp r ->
...
let joinSetup_1 : 'c2 Cert.t -> Cs.Vec.V.t -> Cs.Vec.V.t option Rtree.t -> Cs.Vec.V.t -> 'c1 t
...
let joinSetup_2 : 'c1 Cert.t -> Cs.Vec.V.t -> Cs.Vec.V.t option Rtree.t -> Cs.Vec.V.t -> 'c2 t
	-> Cs.Vec.V.t * Cs.Vec.V.t option Rtree.t * (('c1,'c2) discr_t) t
...
let minkowskiSetup_1 : 'c2 Cert.t -> Cs.Vec.V.t -> Cs.Vec.V.t option Rtree.t -> 'c1 t
	-> Cs.Vec.V.t * Cs.Vec.V.t option Rtree.t * (('c1,'c2) discr_t) t
...
let minkowskiSetup_2 : 'c1 Cert.t -> Cs.Vec.V.t -> Cs.Vec.V.t option Rtree.t -> 'c2 t
	-> Cs.Vec.V.t * Cs.Vec.V.t option Rtree.t * (('c1,'c2) discr_t) t
