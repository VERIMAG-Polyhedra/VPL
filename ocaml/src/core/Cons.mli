...
val elimc : 'c Factory.t -> Cs.Vec.V.t -> 'c t -> 'c t -> 'c t
val elim : 'c Factory.t -> Cs.Vec.V.t -> 'c t -> Cs.t -> Cs.t * 'c t
val rename : 'c Factory.t -> Cs.Vec.V.t -> Cs.Vec.V.t -> 'c t -> 'c t
...
val joinSetup_1 : 'c2 Factory.t -> Cs.Vec.V.t -> Cs.Vec.V.t option Rtree.t -> Cs.Vec.V.t -> 'c1 t
	-> Cs.Vec.V.t * Cs.Vec.V.t option Rtree.t * (('c1,'c2) discr_t) t

val joinSetup_2 : 'c1 Factory.t -> Cs.Vec.V.t -> Cs.Vec.V.t option Rtree.t -> Cs.Vec.V.t -> 'c2 t
	-> Cs.Vec.V.t * Cs.Vec.V.t option Rtree.t * (('c1,'c2) discr_t) t

val minkowskiSetup_1 : 'c2 Factory.t -> Cs.Vec.V.t -> Cs.Vec.V.t option Rtree.t -> 'c1 t
	-> Cs.Vec.V.t * Cs.Vec.V.t option Rtree.t * (('c1,'c2) discr_t) t

val minkowskiSetup_2 : 'c1 Factory.t -> Cs.Vec.V.t -> Cs.Vec.V.t option Rtree.t -> 'c2 t
    	-> Cs.Vec.V.t * Cs.Vec.V.t option Rtree.t * (('c1,'c2) discr_t) t
