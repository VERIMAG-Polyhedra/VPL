(* OASIS_START *)
(* DO NOT EDIT (digest: 98e6768a258d1192ec041557e60a5dce) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("vpl", ["src"], [])];
     lib_c =
       [
          ("vpl",
            "src",
            [
               "src/raytracing/double.h";
               "src/raytracing/glpkInterface.h";
               "src/raytracing/ioInterface.h";
               "src/raytracing/point.h";
               "src/raytracing/polyhedron.h";
     ...
     flags =
       [
          (["oasis_library_vpl_ccopt"; "compile"],
            [
               (OASISExpr.EBool true,
                 S
                   [
                      ...
                      A "-ccopt";
                      A "-I/usr/local/opt/llvm/include";
                      A "-ccopt";
                      A "-x";
                      A "-ccopt";
                      A "c++";
          ...
          (["oasis_library_vpl_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true,
                 S
                   [
       ...
       [
          ("src/smt",
            [
               ...
               "src/lin";
               "src/lin/handelman";
               "src/lin/handelman/oracle";
               "src/lin/intervalization";
               "src/lin/poly";
               "src/misc";
               "src/plp"
            ]);
